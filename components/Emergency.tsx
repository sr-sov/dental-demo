            ...
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-wc-accent px-5 py-3 text-sm font-semibold text-white shadow-lg hover:brightness-[1.05] transition active:scale-[0.98] cursor-pointer"
                >
                  📞 Call (587) 555-0142
                </a>
              </div>
